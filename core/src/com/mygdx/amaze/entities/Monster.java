...
public class Monster {
    ...
    private Music laugh = Gdx.audio.newMusic(Gdx.files.internal("sound/kefkalaugh.mp3"));
    private Music death = Gdx.audio.newMusic(Gdx.files.internal("sound/monsterdeath.mp3"));
